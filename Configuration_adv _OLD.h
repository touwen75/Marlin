...
#define HOMING_BUMP_DIVISOR { 5, 5, 7, 2 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#if ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 2 // SD,LCD,Buttons take more memory, block buffer needs to be smaller
#else
