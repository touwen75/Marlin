...
void report_current_position() {
  ...
  #if NON_E_AXES > 3
    SERIAL_ECHOPAIR(" " AXIS4_NAME ":", LOGICAL_I_POSITION(current_position[I_AXIS]));
    #if NON_E_AXES > 4
      SERIAL_ECHOPAIR(" " AXIS5_NAME ":", LOGICAL_J_POSITION(current_position[J_AXIS]));
      #if NON_E_AXES > 5
        SERIAL_ECHOPAIR(" " AXIS6_NAME ":", LOGICAL_K_POSITION(current_position[K_AXIS]));
      #endif
    #endif
  #endif
