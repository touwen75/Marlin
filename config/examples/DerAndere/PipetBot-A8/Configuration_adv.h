...
#if NON_E_AXES == 6
  //#define HOMING_BACKOFF_MM { 2, 2, 2, 2, 2, 2 }  // (mm) Move away from the endstops after homing
#elif NON_E_AXES == 5
  //#define HOMING_BACKOFF_MM { 2, 2, 2, 2, 2 }  // (mm) Move away from the endstops after homing
#elif NON_E_AXES == 4
...
//#define LCD_SHOW_E_TOTAL
  ...
  #if NON_E_AXES == 6
    #define SD_FINISHED_RELEASECOMMAND "M84 X Y Z I J K E" // You might want to keep the Z enabled so your bed stays in place.
  #elif NON_E_AXES == 5
    #define SD_FINISHED_RELEASECOMMAND "M84 X Y Z I J E" // You might want to keep the Z enabled so your bed stays in place.
  #elif NON_E_AXES == 4
    #define SD_FINISHED_RELEASECOMMAND "M84 X Y Z I E" // You might want to keep the Z enabled so your bed stays in place.
  #else
